        ...
        expand: function () {
            if (this.expanded === false) {
                if ($body.data('menu') == 'vertical-menu-modern') {
                    ...
                    // $('#left-menu-toggle').html("<i data-feather='unlock' style='transform: scale(1.3); color: #b4b7bd !important;'></i>")
                }
                this.transit(
                    function () {
        ...
        collapse: function () {
            if (this.collapsed === false) {
                if ($body.data('menu') == 'vertical-menu-modern') {
                    ...
                    // $('#left-menu-toggle').html("<i data-feather='lock' style='transform: scale(1.3); color: #b4b7bd !important;'></i>")
                }
                this.transit(
                    function () {
